        ...
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    @if(auth()->check() && auth()->user()->hasRole('petshop') && auth()->id() == $service->petshop->user_id)
                        <div>
                    ...
                    @elseif(!auth()->check())
                        <div class="mt-4">
                            <a href="{{ route('login') }}" class="btn btn-primary">
                                <i class="fas fa-sign-in-alt me-2"></i>Faça login para agendar
                            </a>
                        </div>
                    @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(auth()->check() && !auth()->user()->hasRole('petshop') && 
                        ...
                        <div class="mt-4" id="review-form">
                            ...
                            <form action="{{ route('services.reviews.store', $service->id) }}" method="POST">
                                @csrf

...
<div class="container">
    ...
    <div class="row">
                        ...
                        @foreach($relatedProducts as $relatedProduct)
                            <div class="col-md-3 mb-4">
                                <div class="card h-100">
                                    <img src="{{ $relatedProduct->image ? asset('storage/' . $relatedProduct->image) : asset('img/no-image.jpg') }}" class="card-img-top" alt="{{ $relatedProduct->name }}" style="height: 200px; object-fit: cover;">
                                    <div class="card-body">
        ...
        @section('scripts')
            <script>
                // Adicionar eventos para destacar estrelas na avaliação
